            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="addDoctor.jsp">Add Appointment</a>
                            <a class="dropdown-item" href="adminDoctorList.jsp">View Appointment</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px; " >
                <div class="card card-inverse card-success">
                    <div class="card-block bg-success">
                        ...
                        <h1 class="display-1" style="text-align: center"><a href="adminPatientList.jsp"><%= patient%></a></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6" style="margin-top: 20px;">
                <div class="card card-inverse card-warning">
                    <div class="card-block bg-warning">
                        ...
                        <h1 class="display-1" style="text-align: center"><a href="adminAppointmentList.jsp"><%= worker%></a></h1>
                    </div>
                </div>
            </div>
        </div>
